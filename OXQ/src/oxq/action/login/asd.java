...
public class PwFind extends JFrame implements ActionListener, KeyListener {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      // JOptionPane.showMessageDialog(this, "비밀번호를 발송하였습니다.", "Send",
      ...
      for (MemberDTO dto : arrayList) {
         if (dto.getId().equals(id) && dto.getEmail().equals(email)) {
            new SMTPMailSendPassword(id, email);
            ...
            return;
         } else if (!dto.getId().equals(id) || dto.getEmail().equals(email)) {
